...
describe("resolveAnchors", () => {
    it("returns empty array for empty input", () => {
        ...
        assert.deepStrictEqual(resolveAnchors(null), []);
        assert.deepStrictEqual(resolveAnchors(undefined), []);
    });
    ...
    it("drops anchors where line is null", () => {
        const anchors = [
            { path: "internal/a.go", line: null, is_resolved: false, is_outdated: false },
            { path: "internal/b.go", line: 20, is_resolved: false, is_outdated: false },
        ];
        const result = resolveAnchors(anchors);
        assert.equal(result.length, 1);
    ...
    it("drops anchors that are both outdated and have null line", () => {
        const anchors = [
            { path: "internal/a.go", line: null, is_resolved: false, is_outdated: true },
            { path: "internal/b.go", line: 20, is_resolved: false, is_outdated: false },
        ];
        const result = resolveAnchors(anchors);
        assert.equal(result.length, 1);
    ...
    it("preserves order of kept anchors", () => {
        const anchors = [
            ...
            { path: "d.go", line: null, is_resolved: false, is_outdated: false },
...
//# sourceMappingURL=remap-anchors.test.js.map