...
function makeThread(overrides) {
    return {
        path: overrides.path || "internal/service.go",
        ...
        human_bodies: overrides.human_bodies || ["Fixed per review feedback"],
        latest_author: overrides.latest_author,
        latest_body_excerpt: overrides.latest_body_excerpt,
    };
}
describe("learnings injection integration", () => {
    ...
    it("background: overall output ≤ 8192 bytes", () => {
        ...
        const threads = Array.from({ length: 100 }, (_, i) => makeThread({
            path: `file${i}.go`,
            line: i + 1,
            is_resolved: true,
            is_outdated: false,
...
//# sourceMappingURL=learnings-injection.test.js.map