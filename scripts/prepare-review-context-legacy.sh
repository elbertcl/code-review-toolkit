...
if [ -f AGENTS.md ]; then printf '## AGENTS.md (coding standards)\n\n```markdown\n' >> "${OUT}"; cat AGENTS.md >> "${OUT}"; printf '\n```\n\n' >> "${OUT}"
elif [ -f CLAUDE.md ]; then printf '## CLAUDE.md (coding standards)\n\n```markdown\n' >> "${OUT}"; cat CLAUDE.md >> "${OUT}"; printf '\n```\n\n' >> "${OUT}"; fi
